...
const (
	...
	InventoryService_GetHoldStatus_FullMethodName           = "/inventory.v1.InventoryService/GetHoldStatus"
...
type InventoryServiceClient interface {
	...
	// Get hold status (frontend checkout sync)
	GetHoldStatus(ctx context.Context, in *GetHoldStatusRequest, opts ...grpc.CallOption) (*GetHoldStatusResponse, error)
...
func (c *inventoryServiceClient) GetHoldStatus(ctx context.Context, in *GetHoldStatusRequest, opts ...grpc.CallOption) (*GetHoldStatusResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetHoldStatusResponse)
	err := c.cc.Invoke(ctx, InventoryService_GetHoldStatus_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type InventoryServiceServer interface {
	...
	// Get hold status (frontend checkout sync)
	GetHoldStatus(context.Context, *GetHoldStatusRequest) (*GetHoldStatusResponse, error)
	// Admin: Initialize inventory for a trip
...
func (UnimplementedInventoryServiceServer) GetHoldStatus(context.Context, *GetHoldStatusRequest) (*GetHoldStatusResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetHoldStatus not implemented")
}
...
func _InventoryService_GetHoldStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetHoldStatusRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InventoryServiceServer).GetHoldStatus(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: InventoryService_GetHoldStatus_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InventoryServiceServer).GetHoldStatus(ctx, req.(*GetHoldStatusRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var InventoryService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetHoldStatus",
			Handler:    _InventoryService_GetHoldStatus_Handler,
		},
		{
